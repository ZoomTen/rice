...
as_directory = /home/zumi/Pictures/screenshot
as_launch_app = feh
...
as_next_all_button = Disabled
as_next_all_key = <Alt>Right
as_prev_all_button = Disabled
as_prev_all_key = <Alt>Left
...
as_zoom_time = 0.400000
as_expo_immediate_move = true
as_expo_animation = 0
as_deform = 0
as_distance = 0.130000
...
s0_names = Browse;Draw;Music;Talk;
s0_display_time = 1.000000
s0_fade_time = 0.250000
s0_bold_text = false
s0_text_font_family = Helvetica 55 Roman
s0_text_font_size = 32
s0_text_placement = 0
s0_back_color = #00000099
s0_font_color = #ffffffff
...
as_toggle_bubbles_key = Disabled
...
as_prev_key = Disabled
as_prev_button = Disabled
as_left_window_key = <Alt><Super>Left
as_right_window_key = <Alt><Super>Right
as_up_window_key = <Alt><Super>Up
as_down_window_key = <Alt><Super>Down
...
[animation]
s0_open_effects = animation:Glide 2;animation:None;animation:Fade;animation:Zoom;
s0_open_durations = 120;80;80;120;
s0_open_matches = ((type=Normal | Unknown) | name=sun-awt-X11-XFramePeer | name=sun-awt-X11-XDialogPeer) & !(role=toolTipTip | role=qtooltip_label) & !(type=Normal & override_redirect=1) & !(name=gnome-screensaver);((type=Menu | PopupMenu | DropdownMenu | Combo | Normal) & !(class=\\.exe$));(type=Tooltip | Notification | Utility) & !(name=compiz) & !(title=notify-osd);(type=Dialog | ModalDialog);
s0_open_options = ;;;;
s0_open_random_effects = 
s0_close_effects = animation:Glide 2;animation:Fade;animation:Fade;animation:Glide 2;
s0_close_durations = 120;125;50;120;
s0_close_matches = ((type=Normal | Unknown) | name=sun-awt-X11-XFramePeer | name=sun-awt-X11-XDialogPeer) & !(role=toolTipTip | role=qtooltip_label) & !(type=Normal & override_redirect=1) & !(name=gnome-screensaver) & !(name=gnome-screenshot);((type=Menu | PopupMenu | DropdownMenu | Combo) & !(class=\\.exe$));(type=Tooltip | Notification | Utility) & !(name=compiz) & !(title=notify-osd);(type=Dialog | ModalDialog | Normal);
s0_close_options = ;;;;
...
[core]
as_active_plugins = core;ccp;move;resize;place;decoration;screenshot;text;switcher;mousepoll;showdesktop;workspacenames;titleinfo;regex;png;toggledeco;wall;animation;blur;obs;wobbly;expo;
...
s0_opacity_step = 5
s0_opacity_matches = (type=PopupMenu | DropdownMenu | Combo);
...
s0_filters = blackandwhite;blueish-filter;colornegative;contrast;deuteranopia;grayscale;negative;negative-green;nightmode;nightmodeb;nightmodec;nightmoded;protanopia;sepia;swap-green-blue;swap-red-blue;swap-red-green;swap-hue;
...
[tile]
as_animate_type = 1
as_animation_duration = 250
as_tile_toggle_type = 1
as_tile_join = false
as_tile_delta = 35
...
as_tile_tile_key = <Super>t
as_tile_cascade_key = <Super>c
as_tile_restore_key = Disabled
as_tile_toggle_key = Disabled
